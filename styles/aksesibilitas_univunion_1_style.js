...
function categories_aksesibilitas_univunion_1(feature, value, size, resolution, labelText,
        ...
        stroke: new ol.style.Stroke({color: 'rgba(207,89,57,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.988}),
...
case '2,4km (30 menit)':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(99,230,117,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0.988}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
